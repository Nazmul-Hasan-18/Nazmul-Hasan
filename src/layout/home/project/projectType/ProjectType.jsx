...
const ProjectType = () => {
    ...
    return (
        <div>
            <div className='container mx-auto px-6 lg:px-46 font-[poppins] flex lg:flex-row flex-col lg:justify-between lg:items-center '>
                <div>
                    <h2 className='lg:text-[45px] text-[32px] text-white font-semibold'>My Recent <span className='main_color'>Works</span></h2>
                </div>
                <div className='text-white flex flex-wrap items-center lg:gap-5 gap-2 lg:text-sm  text-[12px] mt-4 lg:mt-0'>
            ...
            <div>
                <ProjectDetails id ={data} ></ProjectDetails>
            </div>
        </div>
    );
};
