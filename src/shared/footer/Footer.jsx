...
const Footer = () => {
    return (
        <div className='bg-black'>
            <div className='container mx-auto  font-[poppins] py-10  '>
                <div className='flex flex-col items-center gap-5'>
                    ...
                    <div className='bg-[#00adb5] text-white box cursor-pointer duration-300 lg:p-3 p-2.5  rounded-full text-sm lg:text-xl'>
                        <FaGithub />
                    </div>
                    </Link>
                    <Link>
                    <div className='bg-[#00adb5] text-white box cursor-pointer duration-300  lg:p-3 p-2.5 hover:main-color rounded-full text-sm lg:text-xl'>
                        <FaLinkedinIn />
                    </div>
                    </Link>
            ...
            <div className='py-4 text-center  border-t font-[poppins] bg-gray-900 text-[13px] lg:text-[16px]'>
